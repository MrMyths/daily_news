...
const publishedAt =
  "香港時間 2026-08-23 09:00（週末自動生成；週日更新版；數據截至美股 8/21 收市）";
...
const sources = [
  ...
  {
    name: "Reuters via Yahoo Finance - Wall St rises on the day but falls for the week",
    url: "https://finance.yahoo.com/markets/stocks/articles/us-stock-futures-rise-sharp-101936269.html",
  },
  {
    name: "Reuters via MarketScreener - Nvidia earnings, Jackson Hole to test pillars of stock rally",
    url: "https://au.marketscreener.com/news/nvidia-earnings-jackson-hole-to-test-pillars-of-stock-rally-ce7858dad88bf024",
  },
  {
  ...
  {
    name: "Reuters via MarketScreener - Oil rises as Trump threatens sanctions on Iran partners",
    url: "https://ca.marketscreener.com/news/oil-set-for-second-weekly-rise-as-unsettled-us-iran-war-crimps-supply-ce7859d3d18af520",
  },
  {
  ...
  },
  {
    ...
    url: "https://ca.finance.yahoo.com/news/global-equity-fund-inflows-hit-092302980.html",
  },
  {
    name: "BLS - Consumer Price Index, July 2026",
  ...
  {
    name: "Reuters - Fed policymakers' inflation concerns increased at July meeting",
    url: "https://www.reuters.com/business/fed-policymakers-inflation-concerns-increased-july-meeting-minutes-show-2026-08-19/",
  },
  {
  ...
  {
    name: "Walmart - Q2 FY2027 earnings release",
  ...
  },
  {
    ...
    url: "https://corporate.target.com/news-features/article/2026/08/q2-2026-earnings",
  },
  {
  ...
  {
    name: "Palo Alto Networks - FY2026 Q4 results date",
    url: "https://www.paloaltonetworks.com/company/press/2026/palo-alto-networks-to-announce-fiscal-fourth-quarter-and-fiscal-year-2026-financial-results-on-tuesday--september-1--2026",
  },
  {
    name: "Ross Stores - Q2 sales and earnings results",
...
const quickTakeaways = [
  "週日更新：週末無新美股交易，最新完整交易週仍截至 8/21 收市；S&P 500 收 7,674.37，週五反彈 0.43%，但全週仍跌 1.43%，結束三連升；Nasdaq 全週 -2.05%，Dow -0.85%。",
  "本週不是單日崩盤，而是高估值市遇上長債息再上：CNBC 8/21 指 10Y 約 4.734%、30Y 約 5.273%，Treasury buyback 只能短暫壓低長端 yields。",
...
const whyMarketMoved = [
  [
    "長債息重上壓力區",
    "CNBC 8/21 指 10Y 約 4.734%、30Y 約 5.273%；Yahoo 早前核對 close 顯示 10Y 約 4.738%、30Y 約 5.276%。Treasury 擴大 long-dated buybacks 只令 yields 短暫回落，之後市場重新擔心供給、赤字與通脹。",
  ],
  [
    "油價把通脹尾巴拉長",
    "Reuters / CNBC：WTI 週五 settle $87.06（全週 +5.66%）、Brent $94.39（全週 +6.39%）。Iran sanctions / Hormuz headlines 令油價強勢，市場擔心能源重新推高 CPI/PPI。",
  ],
  [
    "Walmart 敲響消費警鐘",
...
const topNews = [
  ...
  [
    ...
    "7 月會議三名官員要求即時 +25bp，many participants 認為如 inflation 不回落仍要收緊；CME-linked 快訊顯示 September hold 約 64%-65%，但不是鐵板一塊。",
  ],
  [
    "5",
...
const macroRows = [
  ...
  [
    ...
    "7 月 FOMC 9-3 hold；many participants 指若 inflation 不降仍需 tightening。第三方轉述 CME FedWatch 顯示 September hold 約 63.8%-65.4%、25bp hike 約 34.6%-36.2%。",
    "市場仍偏向 9 月不加息，但 hawkish tail 明顯存在；Jackson Hole 的語氣會影響長端 yields。",
  ],
  [
    "Treasury yields",
    "CNBC 8/21：10Y 4.734%、30Y 5.273%；Yahoo 早前核對口徑顯示 5Y 約 4.424%、10Y 約 4.738%、30Y 約 5.276%。",
  ...
  [
    "Oil",
    "WTI $87.06（全週 +5.66%）、Brent $94.39（全週 +6.39%）。",
    "油價升對 XLE 有利，但對 Fed、消費與 margins 不友善；Brent 近 $94 已是風險資產的壓力來源。",
  ],
  [
    "Gold / Dollar",
    "Gold futures 約 $4,661.60；CNBC 盤中 gold futures $4,647.70、spot $4,588.08，五日約 +4.7%。DXY 精確週收暫無可靠數據，但 CNBC 指美元偏弱是金價支撐之一。",
    "弱美元與債務/通脹避險同時推金價；金與油一齊升，代表市場買的不只是 soft landing。DXY exact close 今日未能可靠交叉核對，所以不作精確點位。",
  ],
];
...
const earningsEvents = [
  ...
  "8/27-8/29：Jackson Hole symposium；Fed Chair Kevin Warsh 首次以主席身份出席。市場未必期待明確 forward guidance，但會聽他如何處理 inflation、Treasury yields 與政策框架。",
  "下週：July PCE / growth 相關數據在 Jackson Hole 前後公布；Reuters 指市場約 pricing 35% September hike chance，CME-linked 快訊顯示 hold 約 64%-65%。",
...
export default function USWeeklyBrief20260823() {
  return (
    <main className="page">
      <style>{`
        .page {
      ...
      <div className="grid">
        ...
        <Card title="2｜大市一眼睇" wide>
          ...
          />
          <p className="small">
            指數點位以 AP / CNBC / Reuters / Yahoo Finance chart
            交叉核對；週變動用 8/14 close 至 8/21 close 計算。CNBC / AP 對
            S&amp;P / Nasdaq 全週百分比作四捨五入，與本文精確計算有輕微差異。
          </p>
        </Card>
        ...
        <Card title="12｜操作提示與最終觀點 / 來源與免責聲明" wide>
          ...
          <ul>
            <li>
              指數：AP、CNBC、Reuters 與 Yahoo chart 對 8/21 close
              基本一致；本文採正式收市點位，週變動用 8/14 至 8/21 close
              計算。週日沒有新美股交易，故本版仍以 8/21 作最新完整交易週。
            </li>
            <li>
              Treasury yields：CNBC 8/21 報導 10Y 4.734%、30Y 5.273%；Yahoo
              chart 日線 close 口徑可有細微時間差，方向一致為長端 yields 回升。
            </li>
            <li>
              FedWatch：CME 本身為即時工具；第三方轉述顯示 September hold 約
              63.8%-65.4%、25bp hike 約
              34.6%-36.2%。本文不混合成單一精確概率，只採共同結論：hold 是 base
              case，但 hike tail 仍在。
            </li>
            <li>
              Commodities：油價採 Reuters / CNBC 週五 settle；金價存在 futures /
              spot / intraday 差異，本文列明 CNBC 盤中與 Yahoo futures close
              口徑，避免混成一個精確數字。
            </li>
            <li>
