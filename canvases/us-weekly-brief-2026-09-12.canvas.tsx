...
const publishedAt =
  "香港時間 2026-09-12 09:00（週末自動生成；數據截至美股 9/11 收市）";
...
export default function USWeeklyBrief20260912() {
  return (
    <main className="page">
      <style>{`
      ...
      <header className="hero">
        ...
        <p className="subtitle">
          ...
          同債息推低，週五再因油價回落而反彈。 表面上 S&amp;P 500 只跌 0.8%，但
          Russell 2000 跌 2.4%、美股基金大流出，說明資金開始挑剔。
          下週焦點只有一句：Warsh Fed 係咪真的加息，以及會唔會暗示「一加再加」。
        </p>
        <div className="meta">
      ...
      <div className="grid">
        ...
        <Card title="2｜大市一眼睇" wide>
          ...
          <p className="small">
            ...
            close 至 9/11 close 計算。9/7 為 Labor Day
            休市，所以本週實際是四個交易日。
          </p>
        </Card>
