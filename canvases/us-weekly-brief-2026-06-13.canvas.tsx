...
const publishedAt = "香港時間 2026-06-13 09:00";
...
const sources = [
  ...
  {
    name: "CNBC - Stock market news for June 12 2026",
    url: "https://www.cnbc.com/2026/06/11/stock-market-today-live-updates.html",
  },
  {
...
const quickTakeaways = [
  "美股本週是「先震後彈」：S&P 500 收 7,431.46，週升 47.72 點 / 約 +0.65%；Nasdaq、Dow 同樣收復上週部分跌幅。",
  "最強不是 mega-cap tech，而是細價與中型股：Russell 2000 週升 110.47 點 / +3.90%，S&P MidCap 400 升 102.75 點 / +2.78%。",
  "升市主線有三條：SpaceX 史上最大 IPO 帶動風險胃納、U.S.-Iran 潛在協議令油價急回、半導體/AI 經歷大波動後有資金回補。",
  "宏觀未算安全：May CPI +4.2% YoY、PPI +6.5% YoY，反映能源衝擊已傳入通脹數據；FedWatch 仍顯示 6/17 FOMC 維持 3.50%-3.75% 機率 97.1%。",
  "板塊廣度比上週好：Morningstar 指基本材料 +2.91%、防守消費 +2.53% 領先；通訊服務 -0.68%、能源 -0.01% 落後。",
...
const indexRows = [
  [
    ...
    "51,202.26",
    "+335.48 / +0.66%",
    "Dow 本週由上週五 50,866.78 反彈，週五再升 353.51 點 / +0.70%，屬於 value/cyclical 修復。",
  ],
  [
    "S&P 500",
    "7,431.46",
    "+47.72 / +0.65%",
    "連續震盪後仍能收高；T. Rowe Price 指是過去 11 週第 10 個正週。",
  ],
  [
    "Nasdaq Composite",
    "25,888.84",
    "+179.41 / +0.70%",
    "AI/半導體大上大落，但週末前仍收復部分跌幅；週五只升 +0.31%，動能比小型股弱。",
  ],
  [
    "S&P MidCap 400",
    "3,796.31",
    "+102.75 / +2.78%",
    "中型股受惠利率回落與油價壓力降溫，表現明顯好過大型科技集中盤。",
  ],
  [
    "Russell 2000",
    "2,943.97",
    "+110.47 / +3.90%",
    "本週最搶眼，反映資金由 mega-cap 擴散至細價股；但仍對債息與信貸條件敏感。",
  ],
  [
    "VIX",
    "最新可靠 close：19.44（6/11）",
    "較 6/10 的 22.22 回落 -12.51%",
    "FRED/YCharts 最新可靠日線止於 6/11；6/12 完整官方 close 生成時未見可靠更新，故不硬填。",
  ],
];
...
const whyMarketMoved = [
  [
    "SpaceX IPO",
    "SPCX 以 $135 定價、週五首日交易收約 $161，升約 19%，集資約 $75bn；市場把它當成流動性與風險胃納壓力測試。",
  ],
  [
    "U.S.-Iran / 油價",
    "Trump 取消原定 strikes 並傳出潛在協議，WTI 週五 4pm ET 約 $84.35、Brent settlement $87.33，通脹溢價即時回落。",
  ],
  [
    "通脹數據",
    "CPI headline +0.5% MoM / +4.2% YoY，PPI +1.1% MoM / +6.5% YoY；市場願意反彈，但 Fed 不會因一日油價跌就轉鴿。",
  ],
  [
    "AI capex 分化",
    "Oracle 公布 record backlog 但市場聚焦 AI data-center capex / 融資，Adobe 因 AI freemium 與 CFO 離任急跌，AI 主線變得更挑剔。",
  ],
  [
    "債息回落",
    "10Y 由上週約 4.52% 回到週五下午約 4.48%-4.49%，對 growth multiple 有幫助；但 May inflation 熱，利率風險未解除。",
  ],
];
...
const topNews = [
  [
    "1",
    "SpaceX 完成史上最大 IPO",
    "CNBC/Investopedia 指 SpaceX 以 $135 定價，集資約 $75bn，週五收約 $161，成為本週市場焦點。對美股來講，這不是單一新股，而是檢驗風險資金是否仍願意追大型 growth story。",
  ],
  [
    "2",
    "U.S.-Iran 協議憧憬令油價急回",
    "Investopedia 指 WTI 週五 4pm ET 約 $84.35、Brent 收 $87.33；油價跌幫助市場淡化能源通脹壓力，但雙方對協議條款仍有分歧。",
  ],
  [
    "3",
    "May CPI / PPI 同週公布，headline inflation 偏熱",
    "CPI +4.2% YoY、PPI +6.5% YoY，背後主要是能源；core CPI 月增 +0.2% 較溫和，令市場未有全面 risk-off。",
  ],
  [
    "4",
    "AI 交易由無差別升轉為看 cash flow",
    "Oracle RPO 升至 $638bn 但股價受 AI capex / debt 擔憂拖累；Adobe 因 AI 產品策略與 CFO 離任急跌。市場開始問：AI 收入幾時變成自由現金流？",
  ],
  [
    "5",
    "消費者信心低位反彈，但仍然好脆弱",
    "University of Michigan 初值 48.9，高過 May 的 44.8；一年通脹預期由 4.8% 回落至 4.6%，但仍遠高於年初前水平。",
  ],
];
...
const heatMapRows = [
  [
    ...
    "+2.91%",
    "強綠",
    "Morningstar 口徑本週最佳板塊；受惠周期修復與美元/利率壓力稍降。",
  ],
  [
    "Consumer Defensive",
    "+2.53%",
    "綠燈",
    "防守消費跑出，說明資金不是純追高 beta，仍有防守配置。",
  ],
  [
    "Small Caps",
    "+2.98%（Morningstar）/ Russell 2000 +3.90%",
    "強綠",
    "本週最清晰的廣度改善訊號；細價股受益於債息回落與風險胃納修復。",
  ],
  [
    "Mid Caps",
  ...
  [
    ...
    "波動綠",
    "仍升，但 AI capex 與 software monetization 令個股分化。",
  ],
  [
  ...
  [
    ...
    "-0.01%",
    "中性偏紅",
    "油價因協議憧憬急跌，能源股由避險受惠轉為拖累；長線 flows 仍有支持但短線回吐。",
  ],
];
...
const macroRows = [
  [
    ...
    "Headline 熱主要因 energy；core 月增較溫和，是市場沒有全面恐慌的原因。",
  ],
  [
    "PPI",
    "+1.1% MoM / +6.5% YoY",
    "BLS 指 12 個月升幅為 2022 年 11 月以來最大；企業成本壓力未消失。",
  ],
  [
    "FedWatch",
    "6/17 維持 3.50%-3.75% 機率 97.1%（Updated Jun 12 08:05 EDT）",
    "6 月不動幾乎是 base case；真正風險是聲明、點陣圖與 Warsh 首次記者會。",
  ],
  [
    "10Y Treasury",
    "T. Rowe Price：約 4.48% by Friday afternoon；Trading Economics：約 4.49%",
    "週內先因 inflation / geopolitics 震盪，後因 Iran 降溫回落；對 growth 有短線支撐。",
  ],
  [
    "Oil",
    "WTI 約 $84.35（4pm ET）；Brent settlement $87.33",
    "油價跌是週五 risk-on 關鍵；若協議破局，能源通脹壓力可很快回來。",
  ],
  [
    "Gold / DXY",
  ...
  [
    ...
    "汽油回落幫情緒止跌，但家庭仍覺得通脹壓力重，消費股仍需選擇性看。",
  ],
];
...
const stockRows = [
  [
    "SPCX / SpaceX",
    "IPO $135；週五收約 $160.95-$161.11，升約 19%",
    "本週最大單一事件；大額 IPO 沒有抽乾大市，反而提升 risk appetite。",
  ],
  [
    "TSLA",
    "Investopedia：週五 +1.6%，前一日 +4.6%",
    "Musk ecosystem 因 SpaceX IPO 受關注，但 TSLA 仍要分開看 EV demand 與估值。",
  ],
  [
    "NVDA",
    "週五略升；Investopedia 指 Nvidia 告知中國客戶 Vera CPU 或 8 月可供應",
    "仍是 AI 核心，但本週半導體不再單向上升，出口限制與估值成為雙重變數。",
  ],
  [
    "AMD",
    "Trading Economics/TradingKey 指週五約 +4.7%",
    "在 AI hardware beta 中表現較強；市場偏好有訂單/供應鏈想像的 chip names。",
  ],
  [
    "ORCL",
    "財報後受壓",
    "RPO $638bn 很震撼，但市場更聚焦 AI data-center capex、debt 與 free cash flow。",
  ],
  [
    "ADBE",
    "Investopedia：週五跌近 7%，股價見約 8 年低位",
    "AI freemium 策略壓短期 ARR，CFO 離任增加 governance / execution 折讓。",
  ],
  [
...
const earningsEvents = [
  "6/16-17：FOMC，6/17 14:00 ET 公布議息結果，14:30 ET 記者會；市場幾乎肯定 hold，但點陣圖與通脹措辭會影響 10Y 與 Nasdaq multiple。",
  "6/15-16：BoJ 會議；T. Rowe Price 指市場預期日本可能加息，若 yen / JGB 波動擴大，會影響全球 carry trade。",
  "6/18：Bank of England 會議；歐洲利率與能源通脹同樣受 Middle East 影響。",
  ...
  "6/26：University of Michigan final June sentiment；如果一年通脹預期回升，會再推高 Fed hawkish 風險。",
];
...
const technicalRows = [
  [
    ...
    "7,431.46 收近上週反彈高位；若 7,450 企穩，才可講重新挑戰 7,500；失 7,380 代表反彈質素轉弱。",
  ],
  [
    "Nasdaq Composite",
    "支持 25,500；阻力 26,000",
    "本週收 25,888.84，距 26,000 不遠；若 AI capex concerns 繼續，26,000 會是第一個壓力。",
  ],
  [
    "Russell 2000",
    "支持 2,900；阻力 3,000",
...
const cryptoRows = [
  [
    ...
    "Binance Vision 1m kline：2026-06-12 20:00:00 UTC close，即美股收市 4:00pm ET 附近。",
  ],
  [
    "ETHUSDT / ETH",
    "$1,666.01",
...
export default function USWeeklyBrief20260613() {
  return (
    <main className="page">
      <style>{`
        .page {
      ...
      <div className="grid">
        ...
        <Card title="2｜大市一眼睇" wide>
          ...
          <p className="small">
            ...
            Bloomberg closing data as of 4 p.m. ET）；VIX 因官方/FRED
        ...
        <Card title="8｜重點股票與 Crypto" wide>
          ...
          />
          <p className="small">
            Binance direct API 在此環境可能受地區限制；本文用 Binance Vision
            public data endpoint 的 1-minute kline，時間點為 2026-06-12 20:00:00
            UTC，對比 2026-06-05 同一時間。
          </p>
        </Card>
        ...
        <Card title="12｜操作提示與最終觀點 / 來源與免責聲明" wide>
          ...
          <ul>
            <li>
              ...
              Finance / Bloomberg，4 p.m. ET 收市口徑）；週五日變動以 CNBC /
              Investopedia 一致口徑補充。
            </li>
            <li>
              SpaceX：Investopedia、CNBC 與 TradingKey 對收市價有
              $160.95-$161.11 小差異；本文用「約 $161 / 約
              +19%」表述，避免過度精確。
            </li>
            <li>
              油價：Investopedia 列 WTI 4 p.m. ET 約 $84.35、Brent settlement
              $87.33；其他市場頁可能因合約與時間點不同而有 $84-$88
              範圍差異，本文註明時間點。
            </li>
            <li>
              VIX：Cboe/FRED/YCharts 在生成時可靠更新至 6/11 close 19.44，未見
              6/12 官方 close，故報告寫「最新可靠 close」而非估算 6/12。
            </li>
            <li>
            ...
            <li>
              Crypto：Binance 直接 API 在環境中可能回 451；本文使用 Binance
              Vision public data 取得 1m kline，沒有使用媒體近似報價。
            </li>
          </ul>
          <p>{disclaimer}</p>
        </Card>
