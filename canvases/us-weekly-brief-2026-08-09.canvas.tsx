...
const publishedAt =
  "香港時間 2026-08-09 09:00（週末自動生成；美股最新交易日為 8/7，週末無新增美股收市）";
...
const sources = [
  ...
  {
    name: "Reuters via MarketScreener - S&P closes at record high as soft jobs report eases rate-hike concerns",
    url: "https://www.marketscreener.com/news/s-p-closes-at-record-high-as-soft-jobs-report-eases-rate-hike-concerns-ce7f50d3d980fe2c",
  },
  {
...
const quickTakeaways = [
  "截至 8/7 美股收市（週末無新增交易日），本週美股強力反彈：S&P 500 全週 +3.58% 並創新高，Nasdaq +5.19%，Dow +2.96%，Russell 2000 +3.52%；VIX 收 14.90，風險胃納明顯改善。",
...
export default function USWeeklyBrief20260809() {
  return (
    <main className="page">
      <style>{`
        .page {
