...
const publishedAt =
  "香港時間 2026-07-11 09:00（週末自動生成；美股最新交易日為 7/10）";
...
const sources = [
  ...
  {
    name: "Reuters via Investing.com - Nasdaq ends sharply higher; chip surge offsets Iran worries",
    url: "https://m.investing.com/news/economy-news/wall-st-futures-rebound-as-oil-retreats-investors-weigh-usiran-tensions-4783449?ampMode=1",
  },
  {
...
const quickTakeaways = [
  ...
  "宏觀主線係中東風險、油價與利率：10Y 收約 4.56%、2Y 約 4.21%，FedWatch/Investing 7/10 14:55 EDT 顯示 7/29 hold 66.8%、加 25bp 33.2%。",
...
const whyMarketMoved = [
  ...
  [
    "利率預期偏鷹",
    "Investing Fed Rate Monitor 顯示 7/29 會議 hold 66.8%、加息 33.2%，比一週前加息風險更高；高估值 growth 對 CPI 會好敏感。",
  ],
  [
    "下週 CPI + 銀行財報前先卡位",
...
const topNews = [
  ...
  [
    "3",
    "半導體與 AI 資本開支仍是市場焦點",
    "Reuters 指 Micron 公布至 2035 年在美投資超過 $250bn，帶動 7/9 chip rally；Meta / Nvidia compute 敘事週五繼續受關注。",
  ],
  [
    "4",
...
const macroRows = [
  ...
  [
    "FedWatch",
    "Investing.com 7/10 14:55 EDT：7/29 hold 66.8%，3.75%-4.00% 加息 33.2%",
...
const stockRows = [
  [
    "NVDA",
    "Motley Fool 即時表：$210.68、+3.90%；其他市場頁提及週五重返超大型市值焦點",
  ...
  [
    "MU / 半導體記憶體",
    "Reuters：Micron 7/9 升 4.5%，宣布至 2035 年在美投資逾 $250bn；SanDisk 亦受惠 memory 敘事",
    "AI infrastructure 仍在吸錢，但 memory 股已很波動，要防止利好出盡後回吐。",
  ],
  [
    "PEP",
...
const watchPlan = [
  ...
  [
    "觀察清單",
    "SPY / QQQ / XLE / XLK / XLF / IWM / NVDA / META / MU / JPM / GS / BTC",
...
export default function USWeeklyBrief20260711() {
  return (
    <main className="page">
      <style>{`
        .page {
